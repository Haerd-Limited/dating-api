...
const (
	...
	SocialsNotAllowedMsg          = "To keep Haerd personality-first, socials aren’t allowed in your display name, job title, work place or university. Please remove @handles, slashes, links, or “dot com” text."
