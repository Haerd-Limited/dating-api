...
import commonprofiledto "github.com/Haerd-Limited/dating-api/pkg/commonlibrary/objects/profilecard/dto"
...
type Profile struct {
	...
	MatchSummary *commonprofiledto.MatchSummary `json:"match_summary,omitempty"`
