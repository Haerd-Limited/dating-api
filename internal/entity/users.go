...
func (r *userR) GetConversationParticipants() ConversationParticipantSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetVerificationVideoSubmissions() VerificationVideoSubmissionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetVerificationVideoSubmissions()
}

func (r *userR) GetVerificationVideoSubmissions() VerificationVideoSubmissionSlice {
	if r == nil {
		return nil
	}

	return r.VerificationVideoSubmissions
}
...
func (o *User) GetVoiceWorthHearingWeeklies() VoiceWorthHearingWeeklySlice {
	if o == nil {
		return nil
	}

	return o.R.GetVoiceWorthHearingWeeklies()
}

func (r *userR) GetVoiceWorthHearingWeeklies() VoiceWorthHearingWeeklySlice {
	if r == nil {
		return nil
	}
...
func (o *User) ConversationParticipants(mods ...qm.QueryMod) conversationParticipantQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"conversation_participants\".\"user_id\"=?", o.ID),
	)
...
// VerificationVideoSubmissions retrieves all the verification_video_submission's VerificationVideoSubmissions with an executor.
func (o *User) VerificationVideoSubmissions(mods ...qm.QueryMod) verificationVideoSubmissionQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"verification_video_submissions\".\"user_id\"=?", o.ID),
	)

	return VerificationVideoSubmissions(queryMods...)
}
...
// VoiceWorthHearingWeeklies retrieves all the voice_worth_hearing_weekly's VoiceWorthHearingWeeklies with an executor.
func (o *User) VoiceWorthHearingWeeklies(mods ...qm.QueryMod) voiceWorthHearingWeeklyQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"voice_worth_hearing_weekly\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadConversationParticipants(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`conversation_participants.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadVerificationVideoSubmissions allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadVerificationVideoSubmissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`verification_video_submissions`),
		qm.WhereIn(`verification_video_submissions.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load verification_video_submissions")
	}

	var resultSlice []*VerificationVideoSubmission
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice verification_video_submissions")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on verification_video_submissions")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for verification_video_submissions")
	}
	...
	if singular {
		object.R.VerificationVideoSubmissions = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &verificationVideoSubmissionR{}
			}
			foreign.R.User = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.VerificationVideoSubmissions = append(local.R.VerificationVideoSubmissions, foreign)
				if foreign.R == nil {
					foreign.R = &verificationVideoSubmissionR{}
				}
				foreign.R.User = local
...
// LoadVoiceWorthHearingWeeklies allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadVoiceWorthHearingWeeklies(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`voice_worth_hearing_weekly`),
		qm.WhereIn(`voice_worth_hearing_weekly.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load voice_worth_hearing_weekly")
	}

	var resultSlice []*VoiceWorthHearingWeekly
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice voice_worth_hearing_weekly")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on voice_worth_hearing_weekly")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for voice_worth_hearing_weekly")
	}
	...
	if singular {
		object.R.VoiceWorthHearingWeeklies = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &voiceWorthHearingWeeklyR{}
			}
			foreign.R.User = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.VoiceWorthHearingWeeklies = append(local.R.VoiceWorthHearingWeeklies, foreign)
				if foreign.R == nil {
					foreign.R = &voiceWorthHearingWeeklyR{}
				}
				foreign.R.User = local
...
func (o *User) AddConversationParticipants(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ConversationParticipant) error {
	var err error
...
// AddVerificationVideoSubmissions adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.VerificationVideoSubmissions.
// Sets related.R.User appropriately.
func (o *User) AddVerificationVideoSubmissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*VerificationVideoSubmission) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			VerificationVideoSubmissions: related,
		}
	} else {
		o.R.VerificationVideoSubmissions = append(o.R.VerificationVideoSubmissions, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &verificationVideoSubmissionR{
				User: o,
			}
		} else {
			rel.R.User = o
...
// AddVoiceWorthHearingWeeklies adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.VoiceWorthHearingWeeklies.
// Sets related.R.User appropriately.
func (o *User) AddVoiceWorthHearingWeeklies(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*VoiceWorthHearingWeekly) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
			...
			values := []interface{}{o.ID, rel.UserID, rel.WeekStart}
	...
	if o.R == nil {
		o.R = &userR{
			VoiceWorthHearingWeeklies: related,
		}
	} else {
		o.R.VoiceWorthHearingWeeklies = append(o.R.VoiceWorthHearingWeeklies, related...)
	}
