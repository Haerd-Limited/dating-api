...
var DeviceTokenWhere = struct {
	...
	Token:     whereHelperstring{field: "\"device_tokens\".\"token\""},
	CreatedAt: whereHelpernull_Time{field: "\"device_tokens\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"device_tokens\".\"updated_at\""},
}
...
func (o *DeviceToken) GetUser() *User {
	if o == nil {
		return nil
	}
...
var (
	deviceTokenAllColumns            = []string{"id", "user_id", "token", "created_at", "updated_at"}
	deviceTokenColumnsWithoutDefault = []string{"user_id", "token"}
	deviceTokenColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
func (q deviceTokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*DeviceToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for device_tokens")
	}
...
func (q deviceTokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (DeviceTokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to DeviceToken slice")
	}
...
func (q deviceTokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count device_tokens rows")
	}
...
func (q deviceTokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if device_tokens exists")
	}
...
func FindDeviceToken(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*DeviceToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from device_tokens")
	}
...
func (o *DeviceToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no device_tokens provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into device_tokens")
	}
...
func (o *DeviceToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update device_tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update device_tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for device_tokens")
	}
...
func (q deviceTokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for device_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for device_tokens")
	}
...
func (o DeviceTokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in deviceToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all deviceToken")
	}
	return rowsAff, nil
}
...
func (o *DeviceToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no device_tokens provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert device_tokens, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(deviceTokenPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert device_tokens, could not build conflict column list")
			}

			conflict = make([]string, len(deviceTokenPrimaryKeyColumns))
			copy(conflict, deviceTokenPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_tokens\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert device_tokens")
	}
...
func (o *DeviceToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no DeviceToken provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from device_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for device_tokens")
	}
...
func (q deviceTokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no deviceTokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from device_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for device_tokens")
	}
...
func (o DeviceTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from deviceToken slice")
	}
...
func (o *DeviceTokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in DeviceTokenSlice")
	}
...
func DeviceTokenExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if device_tokens exists")
	}
