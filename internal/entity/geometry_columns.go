...
func (q geometryColumnQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GeometryColumn, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for geometry_columns")
	}
...
func (q geometryColumnQuery) All(ctx context.Context, exec boil.ContextExecutor) (GeometryColumnSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to GeometryColumn slice")
	}
...
func (q geometryColumnQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count geometry_columns rows")
	}
...
func (q geometryColumnQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if geometry_columns exists")
	}
...
func (o *GeometryColumn) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no geometry_columns provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into geometry_columns")
	}
...
func (o *GeometryColumn) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no geometry_columns provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert geometry_columns, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(geometryColumnPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert geometry_columns, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert geometry_columns")
	}
