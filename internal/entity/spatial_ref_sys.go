...
func (q spatialRefSyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*SpatialRefSy, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for spatial_ref_sys")
	}
...
func (q spatialRefSyQuery) All(ctx context.Context, exec boil.ContextExecutor) (SpatialRefSySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to SpatialRefSy slice")
	}
...
func (q spatialRefSyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count spatial_ref_sys rows")
	}
...
func (q spatialRefSyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if spatial_ref_sys exists")
	}
...
func FindSpatialRefSy(ctx context.Context, exec boil.ContextExecutor, srid int, selectCols ...string) (*SpatialRefSy, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from spatial_ref_sys")
	}
...
func (o *SpatialRefSy) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no spatial_ref_sys provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into spatial_ref_sys")
	}
...
func (o *SpatialRefSy) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update spatial_ref_sys, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update spatial_ref_sys row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for spatial_ref_sys")
	}
...
func (q spatialRefSyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for spatial_ref_sys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for spatial_ref_sys")
	}
...
func (o SpatialRefSySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in spatialRefSy slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all spatialRefSy")
	}
	return rowsAff, nil
}
...
func (o *SpatialRefSy) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no spatial_ref_sys provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert spatial_ref_sys, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(spatialRefSyPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert spatial_ref_sys, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert spatial_ref_sys")
	}
...
func (o *SpatialRefSy) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no SpatialRefSy provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from spatial_ref_sys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for spatial_ref_sys")
	}
...
func (q spatialRefSyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no spatialRefSyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from spatial_ref_sys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for spatial_ref_sys")
	}
...
func (o SpatialRefSySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from spatialRefSy slice")
	}
...
func (o *SpatialRefSySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in SpatialRefSySlice")
	}
...
func SpatialRefSyExists(ctx context.Context, exec boil.ContextExecutor, srid int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if spatial_ref_sys exists")
	}
