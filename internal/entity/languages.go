...
func (languageL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLanguage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"users\".\"id\", \"users\".\"email\", \"users\".\"first_name\", \"users\".\"last_name\", \"users\".\"phone\", \"users\".\"created_at\", \"users\".\"updated_at\", \"users\".\"onboarding_step\", \"users\".\"how_did_you_hear_about_us\", \"users\".\"account_status\", \"users\".\"suspended_until\", \"users\".\"moderation_reason\", \"users\".\"status_updated_at\", \"a\".\"language_id\""),
		qm.From("\"users\""),
