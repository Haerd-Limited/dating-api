...
var (
	refreshTokenDBTypes = map[string]string{`ID`: `uuid`, `UserID`: `uuid`, `Token`: `text`, `ExpiresAt`: `timestamp without time zone`, `Revoked`: `boolean`, `CreatedAt`: `timestamp without time zone`}
	_                   = bytes.MinRead
)
